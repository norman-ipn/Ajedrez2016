...
int abajo (tablero  *board, int x, int y,char jugada[4],int valor)
{
	int v = 1;
	int res = 2;
	while (v<8)
...
int izquierda (tablero *board, int x, int y,char jugada[4],int valor)
{
	int v = 1;
	int res = 2;
	while (v<8)
...
int derecha (tablero *board, int x, int y,char jugada[4],int valor)
{
	int v = 1;
	int res = 2;
	while (v<8)
...
int cruz (tablero *board, int x, int y, char jugada[4],int valor)
{
...
int diagonalard (tablero *board,int x,int y, char jugada [4], int valor)
{
	int v = 1;
	int res = 2;
	while (v<8)
...
int diagonalabd (tablero *board,int x,int y, char jugada [4], int valor)
{
	int v = 1;
	int res = 2;
	while (v<8)
...
int diagonalari (tablero *board,int x,int y, char jugada [4], int valor)
{
	int v = 1;
	int res = 2;
	while (v<8)
...
int diagonalabi (tablero *board,int x,int y, char jugada [4], int valor)
{
	int v = 1;
	int res = 2;
	while (v<8)
...
int diagonal (tablero *board, int x, int y, char jugada[4], int valor)
{
...
int cab1 (tablero *board, int x, int y, char jugada[4], int valor)
{
...
int cab2 (tablero *board, int x, int y, char jugada[4], int valor)
{
...
int cab3 (tablero *board, int x, int y, char jugada[4], int valor)
{
		if (board[x+1][y-2] == ('T'||'Q'||'A'||'C'||'P'))
		{
			if (comparar(x+1,y-2,x,y,valor) == 1)
...
int cab4 (tablero *board, int x, int y, char jugada[4], int valor)
{
		if (board[x+2][y-1] == ('T'||'Q'||'A'||'C'||'P'))
		{
			if (comparar(x+2,y-1,x,y,valor) == 1)
...
int cab5 (tablero *board, int x, int y, char jugada[4], int valor)
{
		if (board[x-2][y-1] == ('T'||'Q'||'A'||'C'||'P'))
		{
			if (comparar(x-2,y-1,x,y,valor) == 1)
...
int cab6 (tablero *board, int x, int y, char jugada[4], int valor)
{
		if (board[x-1][y-2] == ('T'||'Q'||'A'||'C'||'P'))
		{
			if (comparar(x-1,y-2,x,y,valor) == 1)
...
int cab7 (tablero *board, int x, int y, char jugada[4], int valor)
{
...
int cab8 (tablero *board, int x, int y, char jugada[4], int valor)
{
		if (board[x-2][y+1] == ('T'||'Q'||'A'||'C'||'P'))
		{
			if (comparar(x-2,y+1,x,y,valor) == 1)
...
int caballo (tablero *board, int x, int y , char jugada[4], int valor)
{
...
int pe1 (tablero *board, int x, int y, char jugada[4], int valor)
{
...
int pe2 (tablero *board, int x, int y, char jugada[4], int valor)
{
...
int peon (tablero *board, int x, int y, char jugada[4], int valor)
{
	valor = pe1(board,x,y,jugada,valor);
	valor = pe2(board,x,y,jugada,valor);
	return valor;
} 
int lados (tablero *board,int x, int y, char jugada[4], int valor)
{
	int i = -1;
	int k = -1;
	while (i<2)
...
int verificar (tablero *board, int x, int y, int valor,char jugada[4])
{
	switch (board[x][y])
	{
		case 'd':
...
int analizar (tablero *board, char jugada[4])
{
	int x = 0;
	int y = 0;
	int valor = -9;
...
void ia (tablero *board, char jugada[4] )
{
	int valor = 0;
